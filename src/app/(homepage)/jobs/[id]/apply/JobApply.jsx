...
const JobApply = ({ job, applicant }) => {
    ...
    return (
        <div className="max-w-xl mx-auto p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-800 my-4">
            {/* Header Section */}
            <div className="mb-6">
            ...
            <Form onSubmit={handleSubmit} className="flex flex-col gap-5 w-full">
                ...
                {/* Form Actions */}
                <div className="flex items-center justify-end gap-3 mt-2 pt-2 border-t border-zinc-100 dark:border-zinc-800/50">
                    <Button
                        type="reset"
